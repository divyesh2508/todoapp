...
export declare function getHttpAgents(properties: ScannerProperties): Promise<Pick<AxiosRequestConfig, 'httpAgent' | 'httpsAgent'>>;
export declare function resetAxios(): void;
export declare function initializeAxios(properties: ScannerProperties): Promise<void>;
export declare function fetch<T = unknown>(config: AxiosRequestConfig): Promise<import("axios").AxiosResponse<T, any>>;
